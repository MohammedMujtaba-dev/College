function getInputValue() {
  ...
  if (inputVal == 1) {
    document.getElementById("demo").innerHTML =
      "AMANULLAH RAHAMATULLABHAI ATHANIYA";
    ...
    document.getElementById("demo").innerHTML =
      "ZAIDALI MEHDIHUSSAIN CHOUDHARY";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 10) {
    ...
    document.getElementById("demo").innerHTML =
      "MAHMILFATEMA PARVEZALI KADIWALA";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 15) {
    ...
    document.getElementById("demo").innerHTML =
      "MOHAMMADADIL MAHEBUBKHAN MOGAL";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 17) {
    ...
    document.getElementById("demo").innerHTML =
      "SHAILESHKUMAR NARESHBHAI PRAJAPATI";
    document.getElementById("demo1").innerHTML = "7500";
  } else if (inputVal == 26) {
    document.getElementById("demo").innerHTML =
      "VIKASHBHAI NARESHBHAI PRAJAPATI";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 27) {
    ...
    document.getElementById("demo").innerHTML =
      "MAHAMAD HANIF FARUKBHAI SAIYED";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 29) {
    ...
    document.getElementById("demo").innerHTML =
      "JAYDIPSINH JASHVANTSINH SOLANKI";
    document.getElementById("demo1").innerHTML = "0";
  } else if (inputVal == 31) {
    document.getElementById("demo").innerHTML =
      "MOHAMMADMISAM ALIAKBAR SUNASARA";
    document.getElementById("demo1").innerHTML = "2500";
  } else if (inputVal == 32) {
    document.getElementById("demo").innerHTML =
      "MUSKANFATEMA NASIMHAIDAR SUNASARA";
    document.getElementById("demo1").innerHTML = "10000";
  } else if (inputVal == 33) {
    document.getElementById("demo").innerHTML =
      "SAHILBHARATHI HIRABHARATHI SWAMI";
    document.getElementById("demo1").innerHTML = "7500";
  } else if (inputVal == 34) {
